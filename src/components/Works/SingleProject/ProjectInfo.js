        ...
        <div className="image_container">
          <Slide left>
            ...
            <div
              ...
              style={{
                visibility:
                  data[props.data.id - 1].images.length == 0
                    ? "hidden"
                    : "visible",
              }}
            >
              <img
                onClick={({ target }) => changeImage(target.src, target)}
                src={data[props.data.id - 1].images[0]}
              />
              <img
                onClick={({ target }) => changeImage(target.src, target)}
                src={data[props.data.id - 1].images[1]}
              />
              <img
                onClick={({ target }) => changeImage(target.src, target)}
                src={data[props.data.id - 1].images[2]}
              />
            </div>
          </Slide>
              ...
              <Slide bottom>
                <div className="icon_container">
                  <span>
                    <p>Platform</p>
                    <img
                      src={i.platform == "mobile" ? Mobile : Web}
